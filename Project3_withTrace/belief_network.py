...
assumed_door_width = 100 # Assumed door width including ridges in cm
total_door_width = 0
...
async def update_belief_state(robot_x, robot_y, sensor_distances, stop_robot, return_to_start, door_count_goal, observation_sequence=None, override_state=None):
    global state, previous_heading, door_start_heading, recent_positions, distance_travelled_in_frame, distance_travelled_after_door, doors_passed, total_door_width
    ...
    if len(recent_positions) == 2:
        ...
        if state == "wall_following":
            ...
            total_door_width = distance_travelled_in_frame
